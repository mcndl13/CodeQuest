...
const DashboardIcon = () => (
  ...
  <path d="M14.1667 12.2246V17.2246M11.6667 14.7246H16.6667M5.00004 8.89124H6.66671C7.58718 8.89124 8.33337 8.14504 8.33337 7.22457V5.5579C8.33337 4.63743 7.58718 3.89124 6.66671 3.89124H5.00004C4.07957 3.89124 3.33337 4.63743 3.33337 5.5579V7.22457C3.33337 8.14504 4.07957 8.89124 5.00004 8.89124ZM13.3334 8.89124H15C15.9205 8.89124 16.6667 8.14504 16.6667 7.22457V5.5579C16.6667 4.63743 15.9205 3.89124 15 3.89124H13.3334C12.4129 3.89124 11.6667 4.63743 11.6667 5.5579V7.22457C11.6667 8.14504 12.4129 8.89124 13.3334 8.89124ZM5.00004 17.2246H6.66671C7.58718 17.2246 8.33337 16.4784 8.33337 15.5579V13.8912C8.33337 12.9708 7.58718 12.2246 6.66671 12.2246H5.00004C4.07957 12.2246 3.33337 12.9708 3.33337 13.8912V15.5579C3.33337 16.4784 4.07957 17.2246 5.00004 17.2246Z" stroke="#64748B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  </svg>
      ...
      <aside className="bg-[#F9FAFB] shadow-[0_16px_44px_rgba(0,0,0,0.07)] rounded-r-[16px] 
        ...
        <nav className="flex-1 flex flex-col px-6 space-y-2">
          {primaryNavItems.map(({ label, Icon, active }, index) => (
            ...
            >
              <Icon />
              <span className={`text-sm font-medium ${active ? "text-[#64748B]" : "text-[#64748B]"}`}>
                {label}
              </span>
            </div>
          ))}
